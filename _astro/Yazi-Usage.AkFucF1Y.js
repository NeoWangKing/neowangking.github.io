import{c as t,r as e,m as s}from"./render-template.8_16Bp_9.js";import{u as i}from"./PostTagsList.DlOmgSxB.js";import"./astro/assets-service.DLSo0gp6.js";import"./jsx-runtime.-xR-R7lh.js";import"./index.SeRWem-E.js";import"./_commonjsHelpers.BosuxZz1.js";import"./clsx.B-dksMZM.js";const a=`<h2 id="简介" class="heading">简介<a href="#简介" class="heading-anchor" aria-label="Heading Anchor"><i class="iconfont icon-link"></i></a></h2>
...
`}function m(){return a}function b(){return[{depth:2,slug:"简介",text:"简介"},{depth:2,slug:"安装与启动",text:"安装与启动"},{depth:2,slug:"核心快捷键速查",text:"核心快捷键速查"},{depth:3,slug:"导航",text:"导航"},{depth:3,slug:"文件操作",text:"文件操作"},{depth:3,slug:"选择",text:"选择"},{depth:3,slug:"搜索与跳转",text:"搜索与跳转"},{depth:3,slug:"其他常用",text:"其他常用"},{depth:2,slug:"shell-集成退出时自动切换目录",text:"Shell 集成：退出时自动切换目录"},{depth:2,slug:"进阶功能",text:"进阶功能"},{depth:3,slug:"图像与媒体预览",text:"图像与媒体预览"},{depth:3,slug:"多标签页与分栏",text:"多标签页与分栏"},{depth:3,slug:"lua-插件系统",text:"Lua 插件系统"},{depth:3,slug:"自定义按键绑定",text:"自定义按键绑定"},{depth:2,slug:"常用指令速记",text:"常用指令速记"}]}const C=t((r,p,o)=>{const{layout:g,...n}=d;return n.file=l,n.url=c,e`${s()}${i(a)}`});export{C as Content,m as compiledContent,C as default,l as file,d as frontmatter,b as getHeadings,F as rawContent,c as url};
