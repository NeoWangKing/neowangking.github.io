import{c as n,r as i,m as e}from"./render-template.BULx868e.js";import{u as t}from"./PostTagsList.pPuxTiVU.js";import"./jsx-runtime.CS_a1tn9.js";import"./index.BJhJL5h9.js";const a=`<h2 id="tailwind-css-简介" class="heading">Tailwind CSS 简介<a href="#tailwind-css-简介" class="heading-anchor" aria-label="Heading Anchor"><i class="iconfont icon-link"></i></a></h2>
...
\`\`\`
`}function F(){return a}function u(){return[{depth:2,slug:"tailwind-css-简介",text:"Tailwind CSS 简介"},{depth:3,slug:"tailwind-css-的优势",text:"Tailwind CSS 的优势"},{depth:2,slug:"安装与配置",text:"安装与配置"},{depth:3,slug:"安装-tailwind-css",text:"安装 Tailwind CSS"},{depth:3,slug:"配置-astro-和-tailwind",text:"配置 Astro 和 Tailwind"},{depth:3,slug:"生成-tailwind-配置文件",text:"生成 Tailwind 配置文件"},{depth:2,slug:"tailwind-的基本使用",text:"Tailwind 的基本使用"},{depth:3,slug:"在-astro-组件中使用",text:"在 Astro 组件中使用"},{depth:3,slug:"在-markdownmdx-中使用",text:"在 Markdown/MDX 中使用"},{depth:3,slug:"响应式设计",text:"响应式设计"},{depth:3,slug:"暗色模式",text:"暗色模式"}]}const f=n((c,v,o)=>{const{layout:r,...s}=l;return s.file=d,s.url=p,i`${e()}${t(a)}`});export{f as Content,F as compiledContent,f as default,d as file,l as frontmatter,u as getHeadings,g as rawContent,p as url};
