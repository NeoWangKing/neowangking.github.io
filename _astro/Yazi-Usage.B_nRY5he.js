import{c as t,m as e,r as s}from"./render-template.sIMcZtWi.js";import{u as i}from"./PostTagsList.Cz_S6vGd.js";import"./jsx-runtime.Cd3NP39U.js";import"./index.BJhJL5h9.js";const a=`<h2 id="简介" class="heading">简介<a href="#简介" class="heading-anchor" aria-label="Heading Anchor"><i class="iconfont icon-link"></i></a></h2>
...
`}function B(){return a}function f(){return[{depth:2,slug:"简介",text:"简介"},{depth:2,slug:"安装与启动",text:"安装与启动"},{depth:2,slug:"核心快捷键速查",text:"核心快捷键速查"},{depth:3,slug:"导航",text:"导航"},{depth:3,slug:"文件操作",text:"文件操作"},{depth:3,slug:"选择",text:"选择"},{depth:3,slug:"搜索与跳转",text:"搜索与跳转"},{depth:3,slug:"其他常用",text:"其他常用"},{depth:2,slug:"shell-集成退出时自动切换目录",text:"Shell 集成：退出时自动切换目录"},{depth:2,slug:"进阶功能",text:"进阶功能"},{depth:3,slug:"图像与媒体预览",text:"图像与媒体预览"},{depth:3,slug:"多标签页与分栏",text:"多标签页与分栏"},{depth:3,slug:"lua-插件系统",text:"Lua 插件系统"},{depth:3,slug:"自定义按键绑定",text:"自定义按键绑定"},{depth:2,slug:"常用指令速记",text:"常用指令速记"}]}const F=t((r,p,o)=>{const{layout:g,...n}=d;return n.file=l,n.url=c,s`${e()}${i(a)}`});export{F as Content,B as compiledContent,F as default,l as file,d as frontmatter,f as getHeadings,u as rawContent,c as url};
