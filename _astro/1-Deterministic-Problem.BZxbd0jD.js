const n="mathematics/MMiP/1-Deterministic-Problem.md",a="posts",i="mathematics/mmip/1-deterministic-problem",$=`
## 数学物理方程的导出
...
2. 两个自变量的方程
   ...
   >
   > 可见，作自变量的代换时，**方程的类型不变**
`,t={title:"数学物理方程的定解问题",author:"NeoWangKing",date:new Date(177270534e4),lastMod:new Date(177322374e4),tags:["数学","物理","数学物理方法","定解问题"],category:["数学","数学物理方法"],summary:"这是我在学习 数学物理方法 过程中的笔记",comments:!0,draft:!1,sticky:0,chapter:1},e={type:"content",filePath:"/home/runner/work/blog-source-code/blog-source-code/src/content/posts/mathematics/MMiP/1-Deterministic-Problem.md",rawData:void 0};export{e as _internal,$ as body,a as collection,t as data,n as id,i as slug};
