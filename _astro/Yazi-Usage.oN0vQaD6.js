import{c as t,r as e,m as s}from"./render-template.BULx868e.js";import{u as i}from"./PostTagsList.pPuxTiVU.js";import"./jsx-runtime.CS_a1tn9.js";import"./index.BJhJL5h9.js";const a=`<h2 id="简介" class="heading">简介<a href="#简介" class="heading-anchor" aria-label="Heading Anchor"><i class="iconfont icon-link"></i></a></h2>
...
</blockquote>`,d={title:"Yazi 终端文件管理器使用指南",author:"NeoWangKing",date:"2026-05-05T04:00:00.000Z",lastMod:"2026-05-05T06:44:47.000Z",tags:["开发工具","终端","文件管理器","Yazi"],category:["开发工具","终端"],type:"misc",summary:"本文详细介绍新一代终端文件管理器 Yazi 的使用方法，包括核心功能、完整的快捷键速查表、Shell 集成配置以及进阶技巧，帮助终端用户提升文件管理效率。",comments:!0,draft:!1,readingMinutes:4.73,words:946},l="/home/runner/work/blog-source-code/blog-source-code/src/content/posts/Development-Tools/NeoVim/Yazi-Usage.md",c=void 0;function u(){return`
## 简介
...
`}function B(){return a}function f(){return[{depth:2,slug:"简介",text:"简介"},{depth:2,slug:"安装与启动",text:"安装与启动"},{depth:2,slug:"核心快捷键速查",text:"核心快捷键速查"},{depth:3,slug:"导航",text:"导航"},{depth:3,slug:"文件操作",text:"文件操作"},{depth:3,slug:"选择",text:"选择"},{depth:3,slug:"搜索与跳转",text:"搜索与跳转"},{depth:3,slug:"其他常用",text:"其他常用"},{depth:2,slug:"shell-集成退出时自动切换目录",text:"Shell 集成：退出时自动切换目录"},{depth:2,slug:"进阶功能",text:"进阶功能"},{depth:3,slug:"图像与媒体预览",text:"图像与媒体预览"},{depth:3,slug:"多标签页与分栏",text:"多标签页与分栏"},{depth:3,slug:"lua-插件系统",text:"Lua 插件系统"},{depth:3,slug:"自定义按键绑定",text:"自定义按键绑定"},{depth:2,slug:"常用指令速记",text:"常用指令速记"}]}const F=t((r,p,o)=>{const{layout:g,...n}=d;return n.file=l,n.url=c,e`${s()}${i(a)}`});export{F as Content,B as compiledContent,F as default,l as file,d as frontmatter,f as getHeadings,u as rawContent,c as url};
