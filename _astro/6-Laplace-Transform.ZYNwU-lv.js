const n="mathematics/ComplexFunction/6-Laplace-Transform.md",t="posts",$="mathematics/complexfunction/6-laplace-transform",a=`
## 拉普拉斯变换
...
`,s={title:"拉普拉斯变换",author:"NeoWangKing",date:new Date(17724924e5),lastMod:new Date(177322374e4),tags:["数学","复变函数","拉普拉斯变换","积分变换"],category:["数学","复变函数论"],summary:"拉普拉斯变换是处理微分方程和系统分析的强有力工具，它通过引入衰减因子将定义域扩展到复频域，从而适用于更广泛的函数。本文介绍拉普拉斯变换的定义、性质、反演方法及其应用实例。",comments:!0,draft:!1,sticky:0,chapter:6},e={type:"content",filePath:"/home/runner/work/blog-source-code/blog-source-code/src/content/posts/mathematics/ComplexFunction/6-Laplace-Transform.md",rawData:void 0};export{e as _internal,a as body,t as collection,s as data,n as id,$ as slug};
