import{c as n,r as e,m as t}from"./render-template.WXlLK0Jw.js";import{u as i}from"./PostTagsList.HAO05exR.js";import"./jsx-runtime.CPK7-dcL.js";import"./index.BufDd4G-.js";import"./_commonjsHelpers.Cpj98o6Y.js";const a=`<p>下面是在 Astro 中编写 Markdown 内容时，可以使用的一些基本 Markdown 语法示例。</p>
...
`}function F(){return a}function g(){return[{depth:2,slug:"标题",text:"标题"},{depth:2,slug:"二级",text:"二级"},{depth:3,slug:"三级-inline-code",text:"三级 inline code"},{depth:4,slug:"四级",text:"四级"},{depth:5,slug:"五级",text:"五级"},{depth:6,slug:"六级",text:"六级"},{depth:2,slug:"段落",text:"段落"},{depth:2,slug:"图片",text:"图片"},{depth:2,slug:"强调",text:"强调"},{depth:2,slug:"删除线",text:"删除线"},{depth:2,slug:"引用",text:"引用"},{depth:2,slug:"分割线",text:"分割线"},{depth:2,slug:"链接",text:"链接"},{depth:2,slug:"表格",text:"表格"},{depth:2,slug:"代码块",text:"代码块"},{depth:3,slug:"syntax",text:"Syntax"},{depth:2,slug:"katex-公式",text:"KaTeX 公式"},{depth:2,slug:"list-types",text:"List Types"},{depth:3,slug:"ordered-list",text:"Ordered List"},{depth:4,slug:"syntax-1",text:"Syntax"},{depth:4,slug:"output",text:"Output"},{depth:3,slug:"unordered-list",text:"Unordered List"},{depth:4,slug:"syntax-2",text:"Syntax"},{depth:4,slug:"output-1",text:"Output"},{depth:3,slug:"nested-list",text:"Nested list"},{depth:4,slug:"syntax-3",text:"Syntax"},{depth:4,slug:"output-2",text:"Output"},{depth:2,slug:"other-elements--abbr-sub-sup-kbd-mark",text:"Other Elements — abbr, sub, sup, kbd, mark"},{depth:3,slug:"syntax-4",text:"Syntax"},{depth:4,slug:"output-3",text:"Output"},{depth:2,slug:"spoiler",text:"Spoiler"},{depth:2,slug:"footnote-label",text:"参考"}]}const b=n((c,r,o)=>{const{layout:v,...s}=l;return s.file=p,s.url=d,e`${t()}${i(a)}`});export{b as Content,F as compiledContent,b as default,p as file,l as frontmatter,g as getHeadings,y as rawContent,d as url};
