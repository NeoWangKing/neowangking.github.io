const n="physics/TheoreticalMechanics/01-Newtonian-Mechanics.md",t="posts",o="physics/theoreticalmechanics/01-newtonian-mechanics",d=`
## 牛顿力学体系

### 牛顿三定律

**第一定律（惯性定律）**：任何物体都保持静止或匀速直线运动的状态，直到其他物体的作用力迫使它改变这种状态为止。这一定律定义了惯性参考系。
...
当质量 $m$ 为常数时，可写为 $\\boldsymbol{F} = m\\boldsymbol{a}$。这是质点动力学的核心方程。
...
- **伽利略相对性原理**：力学定律在所有惯性参考系中形式相同，惯性系之间通过伽利略变换相联系。

## 常见坐标系下的牛顿第二定律

选择合适的坐标系是求解力学问题的关键步骤。
...
这是最直接的坐标表示，适用于力易于分解的情形。

### 平面极坐标系

平面极坐标 $(r,\\theta)$ 与直角坐标的关系为 $x = r\\cos\\theta$，$y = r\\sin\\theta$。位置矢量为 $\\boldsymbol{r} = r \\hat{\\boldsymbol{r}}$。速度和加速度分别为
...
- 径向加速度：$a_r = \\ddot{r} - r\\dot{\\theta}^2$（径向项 + 向心项）
- 横向加速度：$a_\\theta = r\\ddot{\\theta} + 2\\dot{r}\\dot{\\theta}$（角加速度项 + 科里奥利项）
...
这些对称性是物理学中最深刻的原理之一，在分析力学中通过诺特定理得到更严格的表述。

## 总结

牛顿力学以牛顿三定律为基础，通过建立微分方程描述物体的运动。选择合适的坐标系可以简化问题的求解。对于质点系，三大守恒定律提供了强大的分析工具，它们与对称性紧密相关，为后续进入分析力学奠定了基础。
`,a={title:"牛顿力学",author:"NeoWangKing",date:new Date(17724096e5),lastMod:new Date(1782646293e3),tags:["物理","理论力学","牛顿力学","质点力学","守恒定律"],category:["物理","理论力学"],summary:"本文是理论力学课程的第一篇笔记，系统介绍牛顿力学的基本体系，包括牛顿三定律、绝对时空观、常见坐标系下的运动方程、质点系动力学以及三大守恒定律（动量、角动量、能量），为后续分析力学奠定基础。",comments:!0,draft:!1,sticky:0,chapter:1},l={type:"content",filePath:"/home/runner/work/blog-source-code/blog-source-code/src/content/posts/physics/TheoreticalMechanics/01-Newtonian-Mechanics.md",rawData:void 0};export{l as _internal,d as body,t as collection,a as data,n as id,o as slug};
