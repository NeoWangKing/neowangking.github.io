...
`,t={title:"拉格朗日方程",author:"NeoWangKing",date:new Date(17730144e5),lastMod:new Date(1782646337e3),tags:["物理","理论力学","分析力学","约束","虚功原理","达朗贝尔方程","广义坐标","拉格朗日方程"],category:["物理","理论力学"],summary:"本文系统介绍分析力学的核心内容——拉格朗日方程。从牛顿力学的局限出发，引入约束、广义坐标和虚功原理，推导达朗贝尔方程和拉格朗日方程，并讨论平衡条件与约束力的求解方法。",comments:!0,draft:!1,sticky:0},$={type:"content",filePath:"/home/runner/work/blog-source-code/blog-source-code/src/content/posts/physics/TheoreticalMechanics/02-Lagrange-Equations.md",rawData:void 0};export{$ as _internal,i as body,a as collection,t as data,n as id,l as slug};
