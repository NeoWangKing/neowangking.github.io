import{c as o,r as t,m as s}from"./render-template.WXlLK0Jw.js";import{u as e}from"./PostTagsList.HAO05exR.js";import"./jsx-runtime.CPK7-dcL.js";import"./index.BufDd4G-.js";import"./_commonjsHelpers.Cpj98o6Y.js";const i=`<p>Gyoza 选择 font-class 的方式引用图标。这些图标大部分来源于 <a href="https://remixicon.com/" rel="noopener noreferrer" target="_blank">Remix Icons</a><i class="iconfont icon-external-link"></i>，并且在 <a href="https://www.iconfont.cn/" rel="noopener noreferrer" target="_blank">iconfont</a><i class="iconfont icon-external-link"></i> 上进行管理和导出。</p>
<p>下图展示了项目中的所有图标：</p>
...
`}function b(){return i}function x(){return[{depth:2,slug:"为什么不是-svg-图标",text:"为什么不是 SVG 图标？"},{depth:2,slug:"自定义图标",text:"自定义图标"}]}const w=o((r,d,f)=>{const{layout:p,...n}=a;return n.file=c,n.url=l,t`${s()}${e(i)}`});export{w as Content,b as compiledContent,w as default,c as file,a as frontmatter,x as getHeadings,m as rawContent,l as url};
