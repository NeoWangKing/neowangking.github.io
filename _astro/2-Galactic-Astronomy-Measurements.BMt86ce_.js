const n="physics/GalacticAstronomy/2-Galactic-Astronomy-Measurements.md",$="posts",a="physics/galacticastronomy/2-galactic-astronomy-measurements",m=`
## 天体测量基础
...
`,t={title:"星系天文相关测量",author:"NeoWangKing",date:new Date(1773594503e3),lastMod:new Date(1773594503e3),tags:["天文","星系天文学","天体测量","星际介质","星系分类","光度函数"],category:["天文","星系天文学"],summary:"本文系统介绍星系的基本观测性质与测量方法，包括天体测量基础（坐标系、视差、自行、红移）、星等系统、滤光片、颜色、大气与星际消光、星系组成（恒星、气体、尘埃）、星系分类、表面亮度分布、光谱特征以及光度函数。",comments:!0,draft:!1,sticky:0,chapter:2},r={type:"content",filePath:"/home/runner/work/blog-source-code/blog-source-code/src/content/posts/physics/GalacticAstronomy/2-Galactic-Astronomy-Measurements.md",rawData:void 0};export{r as _internal,m as body,$ as collection,t as data,n as id,a as slug};
