...
（注意在原点处有 $\\delta$ 函数项。）
`,a={title:"势",author:"NeoWangKing",date:new Date(17750016e5),lastMod:new Date(17828208e5),tags:["物理","电动力学","势","拉普拉斯方程","镜像法","多极展开"],category:["物理","电动力学"],summary:"本文系统介绍电势的求解方法，包括拉普拉斯方程、分离变量法、镜像法和多极展开，涵盖直角坐标、球坐标和柱坐标下的解。",comments:!0,draft:!1,sticky:0,chapter:5},$={type:"content",filePath:"/home/runner/work/blog-source-code/blog-source-code/src/content/posts/physics/Electrodynamics/05-Potentials.md",rawData:void 0};export{$ as _internal,o as body,l as collection,a as data,n as id,t as slug};
