const n="physics/TheoreticalMechanics/00-Theory-Mechanics-Complete-Review.md",a="posts",$="physics/theoreticalmechanics/00-theory-mechanics-complete-review",t=`
...
**欧拉角**：进动角 $\\varphi$、章动角 $\\theta$、自转角 $\\psi$.
...
| 实心椭圆柱体（椭圆半轴为 $\\\\$ $a$、$b$，长 $l$） |        $Ox$、$Oy$为椭圆半长、$\\\\$ 短轴，$Oz$ 为其轴线        | $I_{11}=m(3b^2+l^2)/12 \\\\ I_{22}=m(3a^2+l^2)/12 \\\\ I_{33}=ma^2/2$         |
...
$$
\\begin{align}
E = \\frac{I_1}{2} (\\dot{\\theta}^2 + \\dot{\\varphi}^2\\sin^2\\theta) + \\frac{L_{k'}^2}{2I_3} + mgl\\cos\\theta = \\text{常数}
\\end{align}
$$
...
> $$
> \\begin{align}
> \\delta S = \\int_{t_1}^{t_2} [\\delta T(q_\\alpha, \\dot{q_\\alpha}, t) - \\sum Q_\\alpha \\delta q_\\alpha]\\mathrm{d} t = 0
> \\end{align}
> $$
...
`,l={title:"理论力学总复习",author:"NeoWangKing",date:new Date(17823456e5),lastMod:new Date(1782726254e3),tags:["物理","理论力学","复习","拉格朗日力学","哈密顿力学","刚体"],category:["物理","理论力学"],summary:"本文是理论力学课程的完整复习笔记，整合了全部十章内容：牛顿力学、拉格朗日方程、两体问题与中心势场、刚体、非惯性参考系、多自由度微振动、阻尼运动、哈密顿理论、哈密顿理论的应用以及流体. 按知识模块系统梳理，包含核心公式、推导思路和关键物理图像.",comments:!0,draft:!1,sticky:0},i={type:"content",filePath:"/home/runner/work/blog-source-code/blog-source-code/src/content/posts/physics/TheoreticalMechanics/00-Theory-Mechanics-Complete-Review.md",rawData:void 0};export{i as _internal,t as body,a as collection,l as data,n as id,$ as slug};
