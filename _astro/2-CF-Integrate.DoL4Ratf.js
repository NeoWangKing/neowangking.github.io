const n="mathematics/ComplexFunction/2-CF-Integrate.md",$="posts",t="mathematics/complexfunction/2-cf-integrate",a=`
## 复变函数的积分
...
`,e={title:"复变函数的积分",author:"NeoWangKing",date:new Date(1772064e6),lastMod:new Date(177322374e4),tags:["数学","复变函数","柯西定理","柯西公式","路积分"],category:["数学","复变函数论"],summary:"本文介绍复变函数的积分理论，包括路积分的定义与性质、柯西定理（单连通与复连通区域）、不定积分与原函数，以及柯西公式及其推论（模数原理、刘维尔定理）。",comments:!0,draft:!1,sticky:0,chapter:2},i={type:"content",filePath:"/home/runner/work/blog-source-code/blog-source-code/src/content/posts/mathematics/ComplexFunction/2-CF-Integrate.md",rawData:void 0};export{i as _internal,a as body,$ as collection,e as data,n as id,t as slug};
