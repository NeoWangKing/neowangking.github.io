const n="mathematics/MMiP/2-Separation-Of-Variables.md",a="posts",$="mathematics/mmip/2-separation-of-variables",i=`
## 齐次方程的分离变量法
...
`,t={title:"分离变量法",author:"NeoWangKing",date:new Date(17730756e5),lastMod:new Date(177322374e4),tags:["数学","物理","数学物理方法","分离变量法"],category:["数学","数学物理方法"],summary:"分离变量法是求解线性偏微分方程定解问题的常用方法，本文系统整理了齐次方程、非齐次方程、非齐次边界条件、泊松方程的处理步骤，并给出小结。",comments:!0,draft:!1,sticky:0,chapter:2},e={type:"content",filePath:"/home/runner/work/blog-source-code/blog-source-code/src/content/posts/mathematics/MMiP/2-Separation-Of-Variables.md",rawData:void 0};export{e as _internal,i as body,a as collection,t as data,n as id,$ as slug};
