const a="physics/TheoreticalMechanics/08-Hamiltonian-Theory.md",n="posts",$="physics/theoreticalmechanics/08-hamiltonian-theory",t=`
## 哈密顿正则方程
...
`,l={title:"经典力学的哈密顿理论",author:"NeoWangKing",date:new Date(1779408e6),lastMod:new Date(1782646738e3),tags:["物理","理论力学","哈密顿力学","正则方程","正则变换","泊松括号","哈密顿-雅可比方程"],category:["物理","理论力学"],summary:"本文是哈密顿理论的核心笔记，系统介绍从拉格朗日力学到哈密顿力学的过渡，包括正则方程、哈密顿原理、变分法、正则变换与四类母函数、泊松括号及其性质、哈密顿-雅可比方程与分离变量法，以及作用量-角变量理论。",comments:!0,draft:!1,sticky:0},p={type:"content",filePath:"/home/runner/work/blog-source-code/blog-source-code/src/content/posts/physics/TheoreticalMechanics/08-Hamiltonian-Theory.md",rawData:void 0};export{p as _internal,t as body,n as collection,l as data,a as id,$ as slug};
