...
`,a={title:"幂级数展开",author:"NeoWangKing",date:new Date(17722152e5),lastMod:new Date(177322374e4),tags:["数学","复变函数","幂级数","泰勒展开","洛朗展开","解析延拓"],category:["数学","复变函数论"],summary:"本文系统整理复变函数中幂级数展开的相关内容，包括复数项级数、幂级数、泰勒级数、解析延拓、洛朗级数以及孤立奇点的分类，重点解释洛朗级数的概念与例子。",comments:!0,draft:!1,sticky:0,chapter:3},f={type:"content",filePath:"/home/runner/work/blog-source-code/blog-source-code/src/content/posts/mathematics/ComplexFunction/3-Power-Series-Expansion.md",rawData:void 0};export{f as _internal,t as body,$ as collection,a as data,n as id,z as slug};
