const n="mathematics/ComplexFunction/4-Residue-Theorem.md",t="posts",a="mathematics/complexfunction/4-residue-theorem",$=`
## 留数定理
...
`,i={title:"留数定理",author:"NeoWangKing",date:new Date(17723052e5),lastMod:new Date(177322374e4),tags:["数学","复变函数","留数定理","实积分"],category:["数学","复变函数论"],summary:"留数定理是复变函数中计算围道积分的强有力工具，并能应用于计算某些实变函数的定积分。本文介绍留数定理及其在实积分计算中的典型应用，辅以具体例子。",comments:!0,draft:!1,sticky:0,chapter:4},m={type:"content",filePath:"/home/runner/work/blog-source-code/blog-source-code/src/content/posts/mathematics/ComplexFunction/4-Residue-Theorem.md",rawData:void 0};export{m as _internal,$ as body,t as collection,i as data,n as id,a as slug};
