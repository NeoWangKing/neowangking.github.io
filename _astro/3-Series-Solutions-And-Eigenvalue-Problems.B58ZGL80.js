const n="mathematics/MMiP/3-Series-Solutions-And-Eigenvalue-Problems.md",$="posts",a="mathematics/mmip/3-series-solutions-and-eigenvalue-problems",x=`
## 特殊函数常微分方程
...
`,_={title:"二阶常微分方程的级数解法以及本征值问题",author:"NeoWangKing",date:new Date(17730774e5),lastMod:new Date(177322374e4),tags:["数学","物理","数学物理方法","常微分方程","级数解法","本征值问题"],category:["数学","数学物理方法"],summary:"本文系统整理二阶线性常微分方程的级数解法（常点邻域和正则奇点邻域）以及施图姆-刘维尔本征值问题，涵盖特殊函数方程的来源、求解步骤和重要性质。",comments:!0,draft:!1,sticky:0,chapter:3},e={type:"content",filePath:"/home/runner/work/blog-source-code/blog-source-code/src/content/posts/mathematics/MMiP/3-Series-Solutions-And-Eigenvalue-Problems.md",rawData:void 0};export{e as _internal,x as body,$ as collection,_ as data,n as id,a as slug};
