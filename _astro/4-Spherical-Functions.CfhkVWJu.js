const n="mathematics/MMiP/4-Spherical-Functions.md",a="posts",i="mathematics/mmip/4-spherical-functions",t=`
...
&f_{l} = \\frac{2l + 1}{2} \\frac{(l - m)!}{(l + m)!}\\int_{0}^{\\pi}{f(\\theta)P_{l}^{m}(\\cos{\\theta})\\,\\sin{\\theta}\\mathrm{d}\\theta}
\\end{aligned}
\\end{cases}
\\end{align}
$$
...
\\end{align}
$$
`,l={title:"球函数",author:"NeoWangKing",date:new Date(1773244847e3),lastMod:new Date(1773755056e3),tags:["数学","物理","数学物理方法","球函数","勒让德多项式","勒让德函数"],category:["数学","数学物理方法"],summary:"本文系统整理球函数的相关知识，。",comments:!0,draft:!1,sticky:0,chapter:4},$={type:"content",filePath:"/home/runner/work/blog-source-code/blog-source-code/src/content/posts/mathematics/MMiP/4-Spherical-Functions.md",rawData:void 0};export{$ as _internal,t as body,a as collection,l as data,n as id,i as slug};
