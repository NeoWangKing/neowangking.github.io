...
- 第二类边界条件：
  ...
  $$
  \\begin{align}
  \\left[N_{n}^{(m)}\\right]^{2} = \\frac{1}{2} \\left(\\rho_{0}^{2} - \\frac{m^{2}}{\\mu_{n}^{(m)}}\\right) \\left[\\mathrm{J}_{m} (\\sqrt{\\mu_{n}^{(m)}}\\rho_{0})\\right]^{2}
  \\end{align}
  $$
...
- 第三类边界条件：
  ...
  $$
  \\begin{align}
  \\left[N_{n}^{(m)}\\right]^{2} = \\frac{1}{2} \\left(\\rho_{0}^{2} - \\frac{m^{2}}{\\mu_{n}^{(m)}} + \\frac{\\rho_{0}^{2}}{\\mu_{n}^{(m)}\\mathrm{H}}\\right) \\left[\\mathrm{J}_{m} (\\sqrt{\\mu_{n}^{(m)}}\\rho_{0})\\right]^{2}
  \\end{align}
  $$
