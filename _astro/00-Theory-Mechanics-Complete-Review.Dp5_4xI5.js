...
> **NOTE**
>
> 这篇笔记我是一边复习一遍写的，所以有些章节我没重点复习的就没有喵～
...
> $$
>
> 这里用到了广义动量的定义 $\\displaystyle p_\\alpha = \\frac{\\partial L}{\\partial \\dot{q}_\\alpha}$ 以及拉格朗日方程 $\\displaystyle \\dot{p}_\\alpha = \\frac{\\partial L}{\\partial q_\\alpha}$ ，于是有
>
> $$
> \\begin{aligned}
