const n="mathematics/ComplexFunction/1-Complex-Function.md",$="posts",a="mathematics/complexfunction/1-complex-function",t=`
## 复数与复数运算
...
- **黎曼面** 围绕支点，将平面沿从支点发出的一条射线剪开，将多个平面如此切开，使其分别对应 $\\mathrm{Arg} z$ 的不同取值范围（比如：$[0,2\\pi)$，$[2\\pi,4\\pi)$），在此基础上，将这些平面的上缘与下缘首尾相接，形成一个自相交的多叶的面，称为函数的**黎曼面**
  ...
  ![黎曼面](/posts/mathematics/ComplexFunction/Complex-Function/001.jpg '黎曼面')
`,e={title:"复变函数",author:"NeoWangKing",date:new Date(17719776e5),lastMod:new Date(177322374e4),tags:["数学","复变函数","解析函数","多值函数","平面标量场"],category:["数学","复变函数论"],summary:"本文介绍复变函数的基础知识，包括复数的表示与运算、复变函数的定义、解析函数的条件与性质、平面标量场的复势表示，以及多值函数的基本概念。",comments:!0,draft:!1,sticky:0,chapter:1},i={type:"content",filePath:"/home/runner/work/blog-source-code/blog-source-code/src/content/posts/mathematics/ComplexFunction/1-Complex-Function.md",rawData:void 0};export{i as _internal,t as body,$ as collection,e as data,n as id,a as slug};
