import{c as o,r as t,m as s}from"./render-template.BULx868e.js";import{u as e}from"./PostTagsList.pPuxTiVU.js";import"./jsx-runtime.CS_a1tn9.js";import"./index.BJhJL5h9.js";const i=`<p>Gyoza 选择 font-class 的方式引用图标。这些图标大部分来源于 <a href="https://remixicon.com/" rel="noopener noreferrer" target="_blank">Remix Icons</a><i class="iconfont icon-external-link"></i>，并且在 <a href="https://www.iconfont.cn/" rel="noopener noreferrer" target="_blank">iconfont</a><i class="iconfont icon-external-link"></i> 上进行管理和导出。</p>
<p>下图展示了项目中的所有图标：</p>
...
<p>注意，这将会替换掉项目中使用的所有图标，所以请确保你知道自己在做什么。</p>`,a={title:"如何在 Gyoza 中使用图标？",author:"lxchapu",date:"2024-05-08T00:00:00.000Z",lastMod:"2024-05-08T00:00:00.000Z",tags:["Icon"],category:["教程","Gyoza"],type:"misc",summary:"讲解了在Gyoza模板中使用图标的方法与规范",comments:!1,draft:!0,readingMinutes:3.36,words:672},c="/home/runner/work/blog-source-code/blog-source-code/src/content/posts/drafted/how-to-use-icons.md",l=void 0;function h(){return`
...
`}function m(){return i}function b(){return[{depth:2,slug:"为什么不是-svg-图标",text:"为什么不是 SVG 图标？"},{depth:2,slug:"自定义图标",text:"自定义图标"}]}const x=o((r,d,f)=>{const{layout:p,...n}=a;return n.file=c,n.url=l,t`${s()}${e(i)}`});export{x as Content,m as compiledContent,x as default,c as file,a as frontmatter,b as getHeadings,h as rawContent,l as url};
