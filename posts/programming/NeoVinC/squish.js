// squish.js
;(function () {
  const app = document.getElementById('squish')
  if (!app) return
  app.width = 800
  app.height = 600
  ...
  WebAssembly.instantiateStreaming(fetch('/posts/programming/NeoVinC/squish.wasm'), {
    ...
    .catch((err) => {
      console.error('squish.wasm 加载失败:', err)
      ctx.fillStyle = '#f00'
      ctx.font = '16px monospace'
      ctx.fillText('squish.wasm 加载失败', 10, 30)
    })
})()
