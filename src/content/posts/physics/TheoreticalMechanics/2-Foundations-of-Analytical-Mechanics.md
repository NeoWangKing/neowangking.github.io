...
title: 分析力学基础
author: NeoWangKing
date: 2026-03-17T23:09:40+08:00
lastMod: 2026-03-18T16:00:00+08:00
tags: [物理, 理论力学, 分析力学, 约束, 虚功原理, 达朗贝尔方程, 广义坐标, 拉格朗日方程]
category: ['物理', '理论力学']
summary: 本文是理论力学课程的第二篇笔记，系统介绍从牛顿力学到分析力学的过渡，包括约束与分类、虚位移与虚功、理想约束、达朗贝尔方程、广义坐标与自由度，以及拉格朗日方程的推导与应用。
comments: true
draft: false
---
